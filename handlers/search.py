...
async def process_search_date(message: Message):
    """Обрабатывает дату поиска"""
    user_id = message.from_id
    ...
    try:
        ...
        await message.answer("Выберите сортировку:", keyboard=keyboard.get_json())
